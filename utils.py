...
@jax.jit
def acc(x, y, z, params, phi_fn):
    dphidx, dphidy, dphidz = jax.grad(phi_fn, argnums=(0,1,2))(x, y, z, params)
    return -jnp.array([dphidx, dphidy, dphidz])

@jax.jit
def hess(x, y, z, params, phi_fn):
    H = jax.hessian(phi_fn, argnums=(0,1,2))(x, y, z, params)
    return jnp.array(H)