...
if __name__ == "__main__":
    ...
    for name in tqdm(names, leave=True):
        if os.path.exists(f'{PATH_DATA}/{name}/dict_results_nlive2000_fixedProgcenter.pkl'):
            with open(f'{PATH_DATA}/{name}/dict_results_nlive2000_fixedProgcenter.pkl', "rb") as f:
