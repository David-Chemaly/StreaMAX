...
if __name__ == "__main__":
    ...
    for name in tqdm(names, leave=True):
        index += 1
        if not os.path.exists(f'{PATH_DATA}/{name}/Plots_nlive{nlive}_fixedProgcenter_MeanModelErr'):
            ...
            new_PATH_DATA = f'{PATH_DATA}/{name}/Plots_nlive{nlive}_fixedProgcenter_MeanModelErr'
